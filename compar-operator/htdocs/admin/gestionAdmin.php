...
<div class="tab">
    <button class="tablinks" onclick="openCity(event, 'London')" id="defaultOpen">Destinations</button>
    <button class="tablinks" onclick="openCity(event, 'Paris')" >Opérateurs</button>
</div>

<div id="London" class="tabcontent">
    <h1><strong>Liste des Destinations : </strong></h1>
...
<div id="Paris" class="tabcontent">
    ...
    <h1><strong>Liste des Opérateurs : </strong></h1>
